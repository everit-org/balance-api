...
public class InactiveDebtorException extends BalanceException {

    /**
     * Serial version UID.
     */
    private static final long serialVersionUID = 6375013133437645299L;

    public InactiveDebtorException(final String message) {
        super(message);
    }
