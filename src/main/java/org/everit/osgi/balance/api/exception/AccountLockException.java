...
public class AccountLockException extends BalanceException {

    /**
     * Serial version UID.
     */
    private static final long serialVersionUID = -6223409142009846723L;

    public AccountLockException(final String message) {
        super(message);
    }

    public AccountLockException(final String message, final Throwable cause) {
        super(message, cause);
    }
