...
public class NonExistentTransferException extends BalanceException {

    /**
     * Serial version UID.
     */
    private static final long serialVersionUID = 3924849800652182655L;

    public NonExistentTransferException(final String message) {
        super(message);
    }
