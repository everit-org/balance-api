...
public class OwnerResourceNotFoundException extends BalanceException {

    private static final long serialVersionUID = 7113051188985359976L;

    public OwnerResourceNotFoundException(final String message) {
        super(message);
    }
