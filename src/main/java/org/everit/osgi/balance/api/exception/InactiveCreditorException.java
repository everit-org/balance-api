...
public class InactiveCreditorException extends BalanceException {

    /**
     * Serial version UID.
     */
    private static final long serialVersionUID = -5356247088045121323L;

    public InactiveCreditorException(final String message) {
        super(message);
    }
