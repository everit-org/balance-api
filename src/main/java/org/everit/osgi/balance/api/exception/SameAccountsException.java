...
public class SameAccountsException extends BalanceException {

    /**
     * Serial version UID.
     */
    private static final long serialVersionUID = 7767489104741472923L;

    public SameAccountsException(final String message) {
        super(message);
    }
